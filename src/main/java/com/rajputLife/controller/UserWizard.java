...
public class UserWizard implements Serializable {
	...
	// @Future
	private LocalDate date2 =LocalDate.parse("2014-02-14");
	...
	public String getFirstName() {
		System.out.println("UserWizard: getFirstName");
		return "firstName from UserWizard";
	}
	
	public void setFirstName(String firstName) {
		System.out.println("UserWizard: setFirstName");
...
//	}
	...
	public String id;
	public String getId() {
		System.out.println("UserWizard: getId");
		return id;
	}
...
//		System.out.println(origRequest.getQueryString());
		System.out.println("UserWizard: setId");
...
//		ProfileController profileController = (ProfileController) ((ServletRequest) FacesContext.getCurrentInstance()).getAttribute("profileController");
//		profileController.reviewFlag = true;
		try {
			ec.redirect(ec.getRequestContextPath() + "/profile?id=2");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
//		return "profile?id=2?faces-redirect=true";
	}
